      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .lp-dots {
          ...
          background-image: radial-gradient(circle, rgba(148,163,184,.06) 1px, transparent 1px);
        ...
        .lp-brand-icon {
          width: 44px; height: 44px; border-radius: 12px; background: #4f46e5;
          display: flex; align-items: center; justify-content: center;
          box-shadow: 0 0 0 1px rgba(99,102,241,.5), 0 4px 16px rgba(79,70,229,.35);
        }
        ...
        .lp-chip {
          ...
          background: rgba(79,70,229,.15); border: 1px solid rgba(99,102,241,.25);
          border-radius: 20px; padding: 4px 12px; font-size: 10px; color: #818cf8;
          font-weight: 700; letter-spacing: 1px; margin-bottom: 1.5rem; width: fit-content;
        }
        .lp-chip-dot {
          width: 6px; height: 6px; border-radius: 50%; background: #4ade80;
          box-shadow: 0 0 6px rgba(74,222,128,.8); animation: lp-pulse 2s ease-in-out infinite;
        }
        @keyframes lp-pulse { 0%, 100% { opacity: 1; } 50% { opacity: .4; } }

        .lp-hero-title {
          font-family: 'Space Grotesk', sans-serif; font-size: 48px; font-weight: 700;
          color: #f1f5f9; line-height: 1.08; letter-spacing: -2px; margin-bottom: 1rem;
        }
        ...
        .lp-right {
          ...
          padding: 2.5rem 2rem; position: relative; z-index: 2;
        }

        .lp-card {
          width: 100%; background: rgba(255,255,255,.045); border: 1px solid rgba(255,255,255,.11);
          border-radius: 22px; padding: 32px 28px; backdrop-filter: blur(20px);
          -webkit-backdrop-filter: blur(20px); position: relative; overflow: hidden;
        }
        .lp-card::before {
          content: ''; position: absolute; top: 0; left: 0; right: 0; height: 3px;
          background: linear-gradient(90deg, #4f46e5, #7c3aed, #0ea5e9); border-radius: 22px 22px 0 0;
        }
        .lp-card::after {
        ...
        .lp-tab {
          ...
          background: transparent; color: #475569; border-radius: 9px; cursor: pointer;
          transition: all .2s ease; font-family: 'Plus Jakarta Sans', sans-serif; letter-spacing: .1px;
        }
        ...
        .lp-input {
          ...
          border-radius: 11px; padding: 11px 14px 11px 38px; font-size: 13px; color: #f1f5f9;
          font-family: 'Plus Jakarta Sans', sans-serif; outline: none; transition: border-color .2s, background .2s;
        }
        ...
        .lp-btn {
          width: 100%; padding: 12px; background: #4f46e5; border: none; border-radius: 11px;
          color: #fff; font-size: 13px; font-weight: 700; font-family: 'Plus Jakarta Sans', sans-serif;
          cursor: pointer; letter-spacing: .2px; transition: background .2s, transform .1s, box-shadow .2s;
              ...
              <form onSubmit={handleSignIn}>
                ...
                <div className="lp-field">
                  ...
                  <div className="lp-input-wrap">
                    ...
                    <input className="lp-input" type="email" placeholder="ramya2@admin.com"
                ...
                <div className="lp-field">
                  ...
                  <div className="lp-input-wrap">
                    ...
                    <input className="lp-input" type={siShowPass ? "text" : "password"}
                      placeholder="Enter your password" value={siPass}
                      onChange={(e) => setSiPass(e.target.value)} required />
